...
function load_stylesheets() {
    ...
    wp_enqueue_style('stylesheet-aos', 'https://unpkg.com/aos@2.3.1/dist/aos.css', array(), '2.3.1', 'all');
    ...
    wp_enqueue_style('stylesheet-custom', $theme_dir . '/assets/stylesheets/custom.css', array('stylesheet-main'), filemtime($theme_path . '/assets/stylesheets/custom.css'), 'all');
}
